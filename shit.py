...
logo = (f''' 
       \033[1;35m        _                       _
              ...
              | |/ _` |/ _ \ '__| '_ \| '_ \
                                          | | (_| |  __/ |  | | | | | | |
              |_|\__,_|\___|_|  |_| |_|_| |_|{purple}「{red}PAID TOOL{purple}」{r} \n''')
...
def overview():
    print(f"\033[0;35m  ━━━━━━━━━━━━━━━━━[{purple}𝙔𝙊𝙐𝙍 𝘼𝘾𝘾𝙊𝙐𝙉𝙏𝙎{purple}]━━━━━━━━━━━━━━━━━━━")
    total_accounts = count_lines("/sdcard/Aqua/toka.txt")
    total_pages = count_lines("/sdcard/Aqua/tokp.txt")
    print(f"  {purple}     TOTAL ACCOUNTS: {dark_gray}{total_accounts}{purple}")
    print(f"  {purple}     TOTAL PAGES: {dark_gray}{total_pages}")
    print(f'{purple}  ══════════════════════════════════════════════════{wh}')
...
def greet_user():
    ...
    if current_time.hour < 12:
        print(f"    Good morning iaernh, {red}{user_name}!{dark_gray}")
    elif current_time.hour < 18:
        print(f"    Good afternoon iaernh, {red}{user_name}!{dark_gray}")
    else:
        print(f"    Good evening iaernh, {red}{user_name}!{dark_gray}")
...
def ip():
    ...
    print(f" {purple}  「{purple}State{r}」{w}:{dark_gray}THIS IS PAID NOT FOR FREE")
    print(f" {purple}  「{purple}IP{r}」{w}:{dark_gray}{ip_response.get('query', ' ')}")
    print(f"{purple}   「{purple}country{r}」{w}:{dark_gray}{ip_response.get('country', ' ')}")
    print(f"{purple}   「{purple}ISP{r}」{w}:{dark_gray}{ip_response.get('isp', ' ')}")
    print(f"{purple}    「{purple}s-key{r}」{w}:{dark_gray}NO NEED FOR SKEY{red}")
    linex()
...
def menu():
    ...
    linex()
    choice = input(f'   {purple}「{r}iaernh Choose {purple}」{purple}»  ')
    menu_actions = {
        '1': Initialize,
        '2': QuickReact,
        '5': C_page,
